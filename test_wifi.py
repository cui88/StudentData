						...
						if os.path.exists(file_path):
							...
							if not user_df.empty:
								...
								if location.strip() in location_list:
									...
									user_df = pd.DataFrame([[user_id,location,duration]], columns=['UserID', 'Location','Duration'])
...
def GetAPMessage():
	...
	device_list = ["8c:a9:82:02:98:e8","fc:ab:90:00:ae:f8","98:5f:d3:e4:01:69","e4:a7:a0:20:40:f9","70:1c:e7:fc:54:cc"]
